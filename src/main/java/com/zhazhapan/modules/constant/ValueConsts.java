...
public class ValueConsts {
    ...
    public static final String[] USER_AGENT = {"mozilla/5.0 (windows nt 10.0; win64; x64) applewebkit/537.36 (khtml, " +
            "" + "like" + "" + " " + "gecko) " + "chrome/59.0.3071.115 " + "safari/537.36", "Mozilla/5.0 " + "" +
            "(Windows NT " + "" + "6.1; " + "" + "" + "" + "Win64; " + "x64; " + "rv:47.0)" + " " + "" +
            "Gecko/20100101" + "" + " " + "Firefox/47.0", "Mozilla/5.0 " + "(Macintosh;" + "Intel " + "Mac OS X" + " " +
            "x.y; " + "rv:42.0) " + "Gecko/20100101" + "" + " " + "Firefox/42.0", "Mozilla/5.0 " + "(X11; " + "Linux"
            ...
            "" + "" + "" + "" + "(iPhone; " + "CPU" + " " + "iPhone" + " " + "" + "" + "OS " + "10_3_1 " + "like" + "" +
            " Mac " + "OS " + "" + "" + "" + "X) " + "AppleWebKit/603.1.30 " + "" + "" + "(KHTML, " + "like " +
            "Gecko) " + "Version/10.0" + " " + "Mobile/14E304 " + "Safari/602.1", "Mozilla/5.0" + " (compatible;" +
            "" + " " + "MSIE 9.0; " + "Windows Phone " + "OS" + " 7.5;" + "" + " " + "Trident/5.0;" + "" + "" + "" +
            "" + "" + "" + " " + "IEMobile/9.0)", "Mozilla/5.0 " + "" + "" + "" + "(iPhone; U; CPU " + "like " + "" +
            "" + "Mac" + " OS " + "X;" + " en)" + " " + "AppleWebKit/420+ " + "" + "" + "(KHTML," + "" + " like " +
