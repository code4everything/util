...
public class ValueConsts {
    ...
    public static final String[] USER_AGENT = {"mozilla/5.0 (windows nt 10.0; win64; x64) applewebkit/537.36 (khtml, " +
            ...
            "Mozilla/5.0 " + "" + "(Windows NT " + "" + "6.1; " + "" + "" + "" + "Win64; " + "x64; " + "rv:47.0)" + "" +
                    " " + "" + "Gecko/20100101" + "" + " " + "Firefox/47.0", "Mozilla/5.0 " + "(Macintosh;" + "Intel " +
            "" + "Mac OS X" + " " + "" + "" + "x.y; " + "rv:42.0) " + "Gecko/20100101" + "" + " " + "Firefox/42.0",
            "Mozilla/5.0 " + "(X11; " + "Linux" + " " + "x86_64) " + "AppleWebKit/537.36 " + "(KHTML, " + "like" + ""
                    + " " + "Gecko) " + "Chrome/51.0.2704.103 " + "" + "" + "" + "" + "Safari/537.36", "Mozilla/5.0 "
            + "" + "" + "" + "" + "" + "(X11;" + " " + "Linux " + "x86_64) " + "" + "" + "" + "AppleWebKit/537.36 " +
            "" + "(KHTML, like " + "Gecko) " + "" + "Chrome/51.0.2704.106" + "" + " " + "Safari/537.36 " +
            "OPR/38.0.2220.41", "Mozilla/5.0 " + "" + "" + "" + "" + "" + "" + "(iPhone; " + "CPU" + " " + "iPhone" +
            ...
            "IEMobile/9.0)", "Mozilla/5.0 " + "" + "" + "" + "(iPhone; U; CPU " + "like " + "" + "" + "Mac" + " OS "
            + "X;" + " en)" + " " + "AppleWebKit/420+ " + "" + "" + "(KHTML," + "" + " like " + "" + "Gecko) " +
